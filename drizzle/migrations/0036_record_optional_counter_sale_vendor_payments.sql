...
COMMENT ON FUNCTION public.record_counter_sale_payment_with_vendor(uuid, numeric, text, text, text, date, uuid, text, text, uuid) IS 'Records an offline counter-sale receipt. Vendor QR selection is optional; when selected, the receipt and linked vendor payment are recorded atomically.';
